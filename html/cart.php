            ...
            <div class="cart-wrapper">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="product-name">
                                    <a class="name" href="#">Lucida Slevless Dress</a>
                                </td>
                                ...
                                <td class="product-price">
                                    <div class="product-price">
                                        <span class="old-price"><i class="fa fa-inr"></i> 195</span>
                                        <span class="sale-price"><i class="fa fa-inr"></i> 100</span>
                                    </div>
                                </td>
                ...
                <div class="cart-btn">
                    <div class="cart-btn-left">
                        <a href="#" class="btn btn-dark btn-hover-primary rounded-pill">Continue Shopping</a>
                    </div>
                    <div class="cart-btn-right">
                        <a href="#" class="btn btn-outline-dark btn-hover-dark rounded-pill">Clear Cart</a>
                        <a href="#" class="btn btn-outline-dark btn-hover-dark rounded-pill">Update Cart</a>
                    </div>
                </div>
            </div>
            <!-- Cart End -->
                ...
                <div class="col-lg-4">
                    ...
                    <div class="cart-totals">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <p class="price"><i class="fa fa-inr"></i> 600.00</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                        ...
                        <div class="cart-total-btn d-grid">
                            <a href="#" class="btn btn-dark btn-hover-primary rounded-pill">Proceed To Checkout</a>
                        </div>
                    </div>
                    <!-- Cart Totals End -->
                </div>
