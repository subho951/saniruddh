                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="single-form">
                                            ...
                                            <input type="text" required placeholder="Apartment, suite, unit etc. (optional)">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="single-form">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="checkout-order">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="Product-price">
                                                    <p><i class="fa fa-inr"></i> 150.00</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="Product-name">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="Product-price">
                                                    <p><i class="fa fa-inr"></i> 600.00</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="Product-name">
                                                ...
                                                <td class="Product-price">
                                                    <p><i class="fa fa-inr"></i> 100.00</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="Product-name">
                                                ...
                                                <td class="total-price">
                                                    <p><i class="fa fa-inr"></i> 700.00</p>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                ...
                                <div class="checkout-payment">
                                        ...
                                        <li>
                                            <div class="single-payment">
                                                <div class="payment-radio radio">
                                                    ...
                                                    <label for="bank"><span></span> Pay Online </label>
                                    ...
                                    <div class="checkout-btn ">
                                        <a class="btn btn-primary btn-hover-dark rounded-pill d-block" href="#">Place Order</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Checkout Form End -->
