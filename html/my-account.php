                    ...
                    <div class="tab-content my-account-tab" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-dashboard">
                            <div class="my-account-dashboard account-wrapper mt-5">
                                    ...
                                    <h3>Hello, Subhomoy !</h3>
                                
                                <p></p>
                                <p>From your account dashboard. you can easily check & view your recent orders, manage your shipping addresses and edit your password and account details.</p>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-6">
                                        ...
                                        <div class="account-address">
                                            <h6 class="name">Subhomoy</h6>
                                            <p>Address line, State</p>
                                            <p>Pincode</p>
                            ...
                            <div class="my-account-details account-wrapper mt-6">
                                ...
                                <div class="account-details">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form">
                                                <button class="btn btn-primary btn-hover-dark rounded-pill">Save Change</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
